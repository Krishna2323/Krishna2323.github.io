    ...
    <header className="header ">
      <nav>
        <div className="footer-links">
            <div className="links">
              <a href="mailto:belivethatkg@gmail.com" rel="noreferrer" target="_blank">
                <svg
              ...
              <a href="https://www.linkedin.com/in/krishnagupta23/" rel="noreferrer" target="_blank">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  x="0px"
                  y="0px"
              ...
              <a href="https://twitter.com/web_devloving" target="_blank" rel="noreferrer">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  x="0px"
                  y="0px"
              ...
              <a href="https://github.com/Krishna2323" target="_blank" rel="noreferrer">
                <img
                  style={{ transform: "scale(1.1)" }}
